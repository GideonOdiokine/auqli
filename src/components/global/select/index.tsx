    ...
    <View>
      <View className="flex-row items-center gap-x-2.5">
        ...
        <Text
          ...
          ellipsizeMode="tail"
          className={cn(
            'text-body-text flex-1 text-sm leading-8 tracking-wider font-SfPro',
            {
...
const Select = <T,>({
  ...
  return (
    <View>
      <Text className="mb-[6px] font-SfPro font-semibold text-white">
        {label}
      </Text>
      <Pressable
        className={cn(
          'flex-row items-center justify-between relative h-[50] px-4 border overflow-hidden rounded-[10] border-[#5E5D6F]',
          {
      ...
      >
        ...
        {canSelect && (
          <View
            className={cn('duration-300 w-4  transform transition-transform', {
              'rotate-90': show,
            })}
          >
