 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.auqli.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.auqli'; // ios bundle id
const PACKAGE = 'com.auqli'; // android package name
const NAME = 'Auqli'; // app name
const EXPO_ACCOUNT_OWNER = 'ruingwe'; // expo account owner
const EAS_PROJECT_ID = '78fb4140-2791-4506-b0eb-fea051b6d74f'; // eas project id
const SCHEME = 'auqli-store'; // app scheme
...
const client = z.object({
  ...
  INTERCOM_ANDROID_API_KEY: z.string(),
  INTERCOM_IOS_API_KEY: z.string(),
  VAR_BOOL: z.boolean(),
});
